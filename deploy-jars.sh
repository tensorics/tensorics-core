...
if [ "$TRAVIS_BRANCH" = 'master' ] && [ "$TRAVIS_PULL_REQUEST" == 'false' ]; then
    ...
    echo "... done"
    gpg --personal-cipher-preferences "AES256 AES192 AES CAST5 3DES" --personal-digest-preferences "SHA256 SHA1 SHA384 SHA512 SHA224" --personal-compress-preferences "ZLIB BZIP2 ZIP Uncompressed" --fast-import codesigning.asc
    echo "Key added"
