...
/**
 * This implementation of {@link KeyValueFunction} only provides values at discrete points of X argument. If value is
 * requested for unavailable value an {@link IllegalDiscreteFunctionUsageException} is thrown.
 * 
 * @author agorzaws
