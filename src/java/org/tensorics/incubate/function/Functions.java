...
public final class Functions {
	 ...
	 * @param scale
	 *            the factor, by which to multiply the function Y values
	...
	/**
	 * Performs numerical integral of given function within full range of given
	 * function. Simplest method of sum of dt*Y.
	 * 
	 * @param function
	 *            the function to treat
	...
	/**
	 * performs numerical integral of given function within start and end
	 * values. Simplest method of sum of dt*Y.
	 * 
	 * @param function
	 *            the function to integrate
	 * @param start
	 *            the lower border of the integration
	 * @param end
	 *            the upper border of the integration
