...
/**
 * A strategy defines how to calculate output values of a function from the a
 * finite set of discrete values (from a discrete function).
 * 
 * @author agorzaws
 * @param <X>
 *            the type of the independent variable (in)
 * @param <Y>
