...
/**
 * Provides a way to create instances of a certain type of objects, which need
 * one argument as their input.
 * 
 * @author kfuchsbe
 * @param <A>
 *            the type of the argument required to create an instance
 * @param <T>
