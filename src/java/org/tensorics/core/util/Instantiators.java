...
/**
 * Contains utility methods which help to instantiate classes which follow
 * certain conventions. The most common one is that e.g. a class provides a
 * constructor with one argument of a certain type.
 * 
 * @author kfuchsbe
 */
public final class Instantiators {
	 ...
	 * @author kfuchsbe
	 * @param <T>
	 *            the type of the objects that will be finally created by the
	 *            instantiators
	 */
