 ...
 * The decision, which factory method to use is based on the following search
 * process: For all the declared methods in the given class check, if the
 ...
 * @param <R>
 *            the type of the return type (the class to instantiate)
 */
