...
/**
 * Contains the starting methods for tensoric eDSL language expressions, related
 * to basic operations of scalar values (field elements). The class is designed
 * that it can be used in both ways: Either that it can be instantiated or that
 * other classes can inherit from it. The latter option makes the language
 * expressions very concise.
 * 
 * @author kfuchsbe
 * @param <V>
