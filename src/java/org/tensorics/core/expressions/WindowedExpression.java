...
/**
 * Expression that evaluates the targetExpression given the result of the
 * enabling expression. The enabling expression is an {@link Expression} of
 * {@link Boolean} that decides if the targetExpression is resolved or not. This
 * expression resolves into an {@link EvaluationStatus}.
 * 
