...
/**
 * An unresolved expression which can be resolved by applying a binary operation
 * on the results of the two operands (left, right). An instance contains the
 * binary operation itself as well as expressions for both operands.
 * 
 * @author kfuchsbe
 * @param <T>
 *            the type of the results of the operands (and the result of the
 *            expression)
 */
