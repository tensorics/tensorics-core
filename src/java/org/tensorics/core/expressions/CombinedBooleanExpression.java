...
/**
 * This expression reduces an {@link Expression} of {@link Iterable} of boolean
 * to an {@link Expression} of a {@link Boolean}. The conversion represents the
 * reduction strategy that will be applied on the iterable.
 * 
