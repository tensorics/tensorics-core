...
/**
 * An expression which contains an operation which will create an object of a
 * certain type just from nothing (with no additional input).
 * 
 * @author kfuchsbe
 * @param <T>
 *            the type of the object which will be created by the contained
 *            operation.
 */
