...
/**
 * Encapsulates all relevant information which is required for calculations of
 * scalars, tensors and iterables. These include the field (which defines the
 * basic operations on scalars) and the the options which define tensors and
