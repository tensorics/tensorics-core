 ...
 * {@code TensoricSupport<Double>}. This is for convenience purposes, so that a
 * simple calculation does not have to inherit from the support class, but can
 * statically import methods from this class.
 * 
 * @author kfuchsbe
 */
