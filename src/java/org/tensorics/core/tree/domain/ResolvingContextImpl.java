...
/**
 * The simplest implementation of a resolving context. It is inspired by the
 * original implementation in the TE-MPE analysis package.
 * 
 * @author kfuchsbe
 */
public class ResolvingContextImpl implements EditableResolvingContext {
	...
	public <R, E extends Expression<R>> R resolvedValueOf(E expression) {
		...
		/*
		 * This cast is safe, because we took care when putting the value that
