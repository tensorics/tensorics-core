...
/**
 * A hamcrest matcher for unit tests, that matches a values of a tensor to be
 * within a certain tolerance compared to the values of a reference (expected)
 * tensor. Further, the shapes of the two tensors have to be equal (conform with
 * the {@link org.tensorics.core.tensor.Shape#equals(Object)} method).
 * 
 * @author kfuchsbe
 * @param <S>
 *            the s
