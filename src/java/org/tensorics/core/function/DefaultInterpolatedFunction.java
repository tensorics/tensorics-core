...
/**
 * Encodes a {@link InterpolatedFunction} as a combination of a
 * {@link DiscreteFunction} plus an {@link InterpolationStrategy}.
 * <p>
 * The obtaining of y-values associated with x-values not defined by the
 * {@link DiscreteFunction} is delegated to the {@link InterpolationStrategy}.
 * 
 * @author caguiler
 * @param <X>
 *            the type of the independent variable must be comparable. Otherwise
 *            is not possible to interpolate.
