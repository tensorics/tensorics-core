...
/**
 * Contains instances of operations on iterables, based on a field. The main
 * purpose is to be able to re-use the instances of the operations, in order to
 * avoid to have to re-create them all the time.
 * 
 * @author kfuchsbe
 * @param <V>
