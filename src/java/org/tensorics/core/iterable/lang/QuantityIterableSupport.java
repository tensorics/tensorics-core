...
/**
 * Contains methods of the tensorics eDSL which deal with iterables of
 * quantities.
 * 
 * @author kfuchsbe
 * @param <V>
 *            the type of the scalar values of the quantities (elements of the
 *            field on which all the operations are based on)
 */
