...
/**
 * An unresolved expression which uses an operation on iterables to produce one
 * value of the same type. An instance will contain the operation to act on the
 * iterable as well as an expression for the iterable on which the operation
 * will have to be performed.
 * 
 * @author kfuchsbe
 * @param <T>
 *            the type of the elements of the iterable and the result of this
 *            expression.
 */
