...
/**
 * An interface which simply defines basic operations on a certain type. The
 * main purpose of this interface is mainly to streamline naming and make
 * consistent refactorings easier.
 * 
 * @author kfuchsbe
 * @param <S>
