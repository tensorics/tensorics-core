...
/**
 * A pair of values, which can eg be used as intermediate results in
 * calculations, where the two values are commonly used together. The content is
 * named as 'left' and 'right' since very often, the two values might contain
 * operands of binary operations.
 * <p>
