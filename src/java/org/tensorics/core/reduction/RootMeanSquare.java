...
/**
 * Performs an rms calculation over all in one direction of a tensor, if used
 ...
 */
public class RootMeanSquare<S> extends ScalarIterableSupport<S> implements
		ReductionStrategy<Object, S> {
