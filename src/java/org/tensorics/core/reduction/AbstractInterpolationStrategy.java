...
/**
 * An abstract interpolation implementation that provides the basic functions
 * like sorting the {@link Comparable} coordinate and finding the PREVIOUS/NEXT
 * instances in the coordinates.
 * 
 * @author agorzaws
 * @param <C>
 *            type of the coordinate, must be {@link Comparable}
 * @param <V>
 *            type of the value in the {@link Tensor}
 */
public abstract class AbstractInterpolationStrategy<C, V> implements InterpolationStrategy<C, V> {
	...
	/**
	 * Extracts the ordered list of the comparable coordinate along which the
	 * interpolation will be done
	 * 
	 * @param tensorWithTheOnlyOneCoordinateOfC
	 *            tensor with only ONE coordinate
	 ...
	 * @param indexMove
	 *            if 0 then the PREVIOUS will be returned, if +1 the NEXT will
	 *            be returned.
