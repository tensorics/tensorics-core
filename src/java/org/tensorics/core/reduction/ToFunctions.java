...
/**
 * A reduction strategy which reduces all elements of dimension {@code <X>} by
 * transforming them into a {@link DiscreteFunction} s from {@code <X>} to
 * {@code <Y>}
 * 
 * @author kfuchsbe, caguiler
 * @param <X>
 *            the type of the values along the X-axis, the type of coordinate
 *            (aka 'the dimension') do be reduced
 * @param <Y>
 *            the type of the tensor elements and also the type of the values
 *            along the Y-axis
 */
