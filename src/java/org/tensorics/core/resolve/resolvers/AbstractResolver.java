...
/**
 * This class should be used as base class for any resolver. It provides the
 * correct functionality to resolve the type of the expression from the generic
 * parameters of the Reolver interface.
 * 
 * @author kfuchsbe
 * @param <R>
 *            the type of the resolved value of the expression to resolve
 * @param <E>
 *            the type of the expression to resolve, which itself has to result
 *            in R
 */
