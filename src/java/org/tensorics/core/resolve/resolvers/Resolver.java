...
/**
 * The version of a resolver, that has its type of objects which it can resolve
 * given in its generic parameters in the class. This is useful for the usage in
