...
/**
 * A resolver for all kind of unary operations. It simply calls the operations
 * functional method with the resolved argument.
 * 
 * @author kfuchsbe
 * @param <R>
 *            the return type of the unary operation
 */
