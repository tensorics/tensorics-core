...
/**
 * An implementation of this interface is responsible for processing a tree of
 * instruction nodes and resolving as many nodes as possible within one
 * resolver.
 * <p>
...
public interface Dispatcher {
	...
	/**
	 * process the tree, starting from the given node and resolve as many nodes
	 * as possible.
	 * 
	 * @param rootNode
	 *            the node which shall be considered as root node of the tree to
	 *            process
	 * @param actualContext
	 *            the current state of the context, which can be used by
	 *            resolvers to look up some values.
