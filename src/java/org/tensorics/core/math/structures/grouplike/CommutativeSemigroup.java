...
/**
 * The algebraic structure of a commutative semigroup, meaning that the
 * operation of the semigroup is commutative and associative.
 * 
 * @author kfuchsbe
 * @param <T>
 *            the type of elements of the underlying set.
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Commutative_semigroup">http://en.wikipedia.org/wiki/Commutative_semigroup
 *      </a>
 */
