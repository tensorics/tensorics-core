...
/**
 * Represents the algebraic structure of a group, which has with respect to a
 * monoid the additional property that it provides a unitary operation, which
 * gives rise to inverse elements.
 * 
 * @author kfuchsbe
 * @param <T>
 *            the type of the elements of the group
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Group_(mathematics)">http://en.wikipedia.org/wiki/Group_(mathematics)</a>
 */
