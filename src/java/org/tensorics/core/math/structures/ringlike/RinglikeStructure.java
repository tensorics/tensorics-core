 ...
 * Typically, they are called addition (+) and multiplication (*). Together with
 * the underlying set of elements, these operations form different grouplike
...
public interface RinglikeStructure<T> extends Structure<T> {
	...
	/**
	 * Returns the grouplike structure representing the multiplication of
	 * elements.
	 * 
