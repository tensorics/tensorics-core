...
/**
 * Utility class that provides methods to access mathematical structures which
 * are available in the tensorics core package.
 * 
 * @author kfuchsbe
 */
public final class Structures {
	...
	/**
	 * Creates a more explicit view of the given field together with the given
	 * implementation of mathematical functions. This way more efficient
	 * implementations can be used.
	 * 
	 * @param field
	 *            the field for which to create the explicit view.
	 * @param math
	 *            the class providing mathematical functions.
	 * @param cheating
	 *            the class that provides some methods for cheating the
	 *            field-framework.
