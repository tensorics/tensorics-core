...
/**
 * The implementation of those special methods which are (still) necessary to
 * convert field elements to doubles and vice versa. Anyhow, the implementation
 * for doubles it is trivial and does not harm.
 * 
 * @author kfuchsbe
 */
public class DoubleCheating implements Cheating<Double> {
	 ...
	 * 
	 * @deprecated the whole class should not be necessary in the future, if the
	 *             unit-conversions are based fully on field operations.
	 */
	@Deprecated
	@Override
