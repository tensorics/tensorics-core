...
public final class Tensorbackeds {
	...
	/**
	 * Creates a new builder for the given tensor backed class. The builder will
	 ...
	 * @return the set of dimensions (classes of coordinates) which are required
	 *         to create an instance of the given class.
	 */
	...
	/**
	 * A convenience method to retrieve the size (number of entries) of a tensor
	 * backed object. This is nothing else than a shortcut to the size of the
	 * underlaying tensor.
	 * 
	 * @param tensorbacked
	 *            the tensor backed object for which to retrieve the size
	...
	/**
	 * Retrieves the validities from a tensorbacked object which contains
	...
	/**
	 * Retrieves the values of a tensorbacked object which contains quantities
	 ...
	 *             if the unit cannot be determined
	 */
	...
	/**
	 * Retrieves all the shapes of the given tensorbacked objects. The order of
	 ...
	 * @return an object which allows to further specify the flattening
	 *         operation
	 */
	...
	/**
	 * Retrieves the tensor from each tensorbacked in the given iterable and
	 ...
	 *            tensors
	 * @return an iterable containing the tensors from the given iterable of
	 *         tensorbackeds
	 */
	...
	/**
	 * Merges the given {@link Tensorbacked}s into one {@link Tensorbacked} of
	 ...
	 * @param classToReturn
	 *            the type of the tensor backed that should be resulting from
	 *            the merge
	 * @return a new tensor backed object resulting from the the merge of the
	 *         tensors
