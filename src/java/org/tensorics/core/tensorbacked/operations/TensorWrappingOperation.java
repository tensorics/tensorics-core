...
/**
 * The default implementation of an operation, which wraps a tensor into a
 * tensorbacked object of a given type.
 * 
 * @author kfuchsbe
 * @param <V>
 *            the type of the values of the tensors and tensorbacked objects
 * @param <TB>
 *            the type of the tensorbacked objects into which tensors will be
 *            wrapped
 */
public class TensorWrappingOperation<V, TB extends Tensorbacked<V>> implements Conversion<Tensor<V>, TB> {
	 ...
	 *            the type of the tensorbacked objects that will be created
	 */
