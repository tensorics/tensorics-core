...
public class OngoingTensorBackedOperation<TB extends Tensorbacked<V>, V> implements OngoingOperation<TB, V> {
	 ...
	 * @param left
	 *            first {@link Tensorbacked} to use
	 */
	...
	/**
	 * Constructs a tensor backed object, of the same type as the input objects,
	 * which will contain elements which are the products of the respective
	 * elements of the input objects.
	 * 
	 * @param right
	 *            second {@link Tensorbacked} to use
	 * @return a tensor backed object of the same as the input object,
	 *         containing the all the values of the left tensor, multiplied by
	 *         the values of the right tensor
	 */
	@Override
	...
	/**
	 * Construct a tensor backed object of the same type of the left given
	 * object, multiplied all the elements with the given tensor.
	 * 
	 * @param right
	 *            the right tensor with which to multiyply all the elements
	 * @return a new tensor backed object, containing all the elements
	 *         muyltiplied by each other
	 */
	...
	/**
	 * Constructs a new tensor backed object of the same type as the left
	 * operand, containing elements divided by the corresponding elements of the
	 * given tensor.
	 * 
	 * @param right
	 *            the tensor with whose elements to divide the elements of the
	 *            left operand
	 * @return a new tensorbacked object containing the left elements divided by
	 *         the right ones
	 */
