 ...
 * @author kfuchsbe
 */
public class SimpleTensorbackedBuilder<V, TB extends Tensorbacked<V>> implements TensorbackedBuilder<V, TB> {
     ...
     */
    SimpleTensorbackedBuilder(Class<TB> tensorbackedClass) {
    ...
    public final SimpleTensorbackedBuilder<V, TB> putAll(Set<java.util.Map.Entry<Position, V>> entries) {
    ...
    public final SimpleTensorbackedBuilder<V, TB> putAll(Position position, Map<Position, V> entries) {
    ...
    public final SimpleTensorbackedBuilder<V, TB> putAll(Map<Position, V> newEntries) {
    ...
    public final SimpleTensorbackedBuilder<V, TB> context(Object... coordinates) {
