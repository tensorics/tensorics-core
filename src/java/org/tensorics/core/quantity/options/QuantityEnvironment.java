 ...
 * This interface provides some convenience methods, which allow to retrieve
 * certain strategies, without the need of casting.
 * 
 * @author kfuchsbe
 * @param <S>
 *            the type of the scalar values (elements of the fields on which all
