...
public final class Positions {
	...
	/**
	 * Constructs a position, whose coordinates are the union of the coordinates
	 * of the two individual positions. This is only correctly defined, if the
	 * two given positions do not have any dimensional overlap (i.e. Any
	 * coordinate of a certain type (class) is only present in either the left
	 * or the right position.)
	 * 
	 * @param left
	 *            the first position to use construct the union position
	 * @param right
	 *            the second position to construct the union position
	 * @return a position, which contains the union of the coordinates of the
	 *         two input positions.
	 * @throws NullPointerException
	 *             if one of the arguments is {@code null}
	 * @throws IllegalArgumentException
	 *             if the given aguments have an overlap of dimensions and
	 *             therefor the union of the position is not well defined
	 */
	 ...
	 * 
	 * @param positions
	 *            the positions, which shall be ensured that they are unique
	 ...
	 *            the dimensions which shall be stripped from the positions
	...
	/**
	 * Checks if the given position is conform with the given coordinate and
	 * throws an exception, if not.
	 * 
	 * @param position
	 *            the position for which to check the consistency
	 * @param dimensions
	 *            the dimensions for which the conformity has to be verified.
	 * @throws IllegalArgumentException
	 *             if the position is not conform
	 ...
	 * 
	 * @param pair
	 *            the pair, whose dimensions should be united
	 * @param targetDimensions
	 *            the dimension in which the positions shall be united
	 ...
	 * 
	 * @param left
	 *            the first of the two positions, whose dimensions should be
	 *            united
	 * @param right
	 *            the second of the two positions whose dimensions should be
	 *            combined
	 * @param targetDimensions
	 *            the dimension in which the positions shall be united
	 ...
	 * 
	 * @param positionPairs
	 *            the position pairs to combine the final positions
	 * @param targetDimensions
	 *            the dimensions in which to combine the positions
	...
	/**
	 * Extracts the provided class of the coordinate from the set of the
	 * positions.
	 * 
	 * @param positions
	 * @param ofClass
	...
	/**
	 * Returns all positions which can be built from all combinations of the
	 * values of the given enum classes.
	 * 
	 * @param enumClasses
	 *            the enum classes from which to get the values from
	...
	/**
	 * Returns all positions which can be built from the values of the passed in
	 * classes that are assumed to be enum classes. This is basically the
	 * runtime-checked version of {@link #cartesianProduct(Class...)}
	 * 
	 * @param enumClasses
	 *            the enum classes from which to get their values
	 * @return an iterable containing the positions which are constructed from
	 *         the values of the enums
	 * @throws IllegalArgumentException
	 *             in case not all clases are enums
	 */
	 ...
	 * 
	 * @param enumClasses
	 *            the enums whose values will be used to create the positions
	 * @return an iterable with positions containing all possible combinations
	 *         of the enum values
	 */
	 ...
	 * Returns all positions which can be built from the values of the passed in
	 * classes that are assumed to be enum classes. This is basically the
	 * runtime-checked version of {@link #cartesianProduct(Set)}
	 * 
	 * @param classes
	 *            the enum classes from which to get their values
	 * @return an iterable containing the positions which are constructed from
