...
public final class Positions {
	 ...
	 * @throws IllegalArgumentException if the given aguments have an overlap of
	 *             dimensions and therefor the union of the position is not well
	 *             defined
	 */
	 ...
	 * @param dimensions the dimensions for which the conformity has to be
	 *            verified.
