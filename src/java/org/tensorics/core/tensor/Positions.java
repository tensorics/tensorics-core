...
public final class Positions {
	...
	public static <C> C coordinatesOf(Class<C> clazz, Position position) {
		for (Object positionCoordinate : position.coordinates()) {
		...
		throw new IllegalArgumentException("Given class '" + clazz
				+ "'cannot be assigned from any of the coordinates in the position '" + position.dimensionSet() + "'!");
	}
