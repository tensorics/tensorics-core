...
/**
 * Part of the tensoric fluent API, which provides methods to specify concretely
 * how a given dimension should be reduced.
 * 
 * @author kfuchsbe
 * @param <C>
 *            the type of coordinate (aka 'the dimension') which is going to be
 *            reduced (by calling methods of this class)
 * @param <E>
