...
/**
 * Part of the tensorics fluent API, that allows to further describe how a
 * tensor dimesion shall be reduced (where the field was not yet known in the
 * previous expression part)
 * 
 * @author kfuchsbe
 * @param <C>
 *            the type of the dimension in which the tensor shall be reduced
 * @param <S>
