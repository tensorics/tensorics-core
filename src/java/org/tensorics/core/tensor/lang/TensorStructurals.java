...
/**
 * Structural manipulations of tensors (which do not require any knowledge about
 * the mathematical behaviour of the elements).
 * 
...
public final class TensorStructurals {
	...
	/**
	 * Merges the given set of the Tensors based on information in their context
	 * and dimensions. This operation is only possible, if the following
	 * preconditions are fulfilled:
	 * <ul>
	 * <li>The contexts of all the tensors have THE SAME dimensions AND</li>
	 * <li>The dimensions of all the tensors are THE SAME (first found tensor
	 * dimension is taken as an reference)</li>
	 * </ul>
	 * 
	 * @param tensors
	 *            to be merged.
	 ...
	 *             if zero or one tensor is put to be merged OR if tensors
	 *             dimensionality and their context positions dimensionality is
	 *             not equal OR tensor context is empty.
	 */
	...
	/**
	 * Checks if the provided tensor has: the same dimension as the reference
	 * dimensions, equal number of them, as well as equal number of Context
	 * Position dimension and referenceContext Position and their
	 * dimensionality.
	 * 
	 * @param tensor
	 *            the tensor to check
	 * @param refDimensions
	 *            the dimensions that the tensor should have
	 * @param refContextDimensions
	 *            the context position the context dimensions, to which the
	 *            tensor shall be compatible
	 * @return {@code true} if the conditions are fulfilled, {@code false} if
	 *         not.
	 */
