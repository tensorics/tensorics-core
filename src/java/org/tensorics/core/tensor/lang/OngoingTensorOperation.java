...
public class OngoingTensorOperation<C, V> implements OngoingOperation<Tensor<V>, V> {
	 ...
	 * 
	 * @param right
	 *            second tensoric to use
	 * @return A tensor, containing elements that are the product of the
	 *         respecive elemtents of the two input tensors
	 */
	@Override
	...
	/**
	 * Performs the inner tensor product of the left tensor with the right
	 * tensor by taking care about co-and contravariant coordinates and
	 * following the tensoric-equivalen of Einsteins sum convention.
	 * 
	 * @param right
	 *            the right tensor to multiply onto the left
