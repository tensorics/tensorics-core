...
/**
 * A pair of positions, usually representing a position in the left tensor of an
 * operation and its corresponding position in the right tensor.
 * 
 * @author kfuchsbe
 */
public final class PositionPair extends AbstractPair<Position> {
	 ...
	 * 
	 * @param leftPosition
	 *            the position within a left tensor of an operation
	 * @param rightPosition
	 *            the position within the right tensor of an operation
	 */
