...
/**
 * Abstract base class for a stream {@link Collector} which is backed by a map
 * of {@link Position} to an arbitrary value, from which a {@link Tensor} or
 * {@link Tensorbacked} can be built in the finalization step.
 * 
 * @author mihostet
 * @param <V>
 *            stream elements
 * @param <T>
 *            elements of the tensor to be produced
 * @param <O>
 *            output (e.g. {@code Tensor<T>} or {@code Tensorbacked<T>})
 */
