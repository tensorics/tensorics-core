...
/**
 * Utility class for producing streams of {@code Entry<Position, T>} out of
 * Tensors and collecting them back into Tensors.
 *
 * @author mihostet
 */
public final class TensorStreams {
	...
	/**
	 * Build a collector to collect a stream of {@code Entry<Position,T>} to a
	 * generic {@code Tensor<T>} of the dimensions defined in the set of
	 * classes.
	 *
	 * @param dimensions
	 *            the dimensions of the tensor to construct
	 * @return
	 */
	...
	/**
	 * Build a collector to collect an arbitrary stream to a generic
	 * {@code Tensor<T>} of the given dimensions. Functions mapping the values
	 * to {@link Position} and T must be provided.
	 *
	 * @param positionMapper
	 *            function mapping stream values to Position
	 * @param valueMapper
	 *            function mapping stream values to tensor values
	 * @param dimensions
	 *            the dimensions of the tensor to construct
	 * @return
	 */
	...
	/**
	 * Build a collector to collect a stream of {@code Entry<Position,T>} to a
	 * {@code Tensorbacked<T>} class. The {@link Position}s in the stream must
	 * be consistent with the dimensions of the Tensorbacked.
	 *
	 * @param tensorBackedClass
	 *            the tensorbacked to produce
	 * @return
	 */
	 ...
	 * The {@link Position}s generated must be consistent with the dimensions of
	 * the Tensorbacked.
	 *
	 * @param tensorBackedClass
	 *            the tensorbacked to produce
