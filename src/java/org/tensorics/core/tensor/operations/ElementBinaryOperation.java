...
/**
 * A binary operations on tensors which can be decoupled into simple operations
 * on an element of one tensor on the corresponding element on the second tensor
 * (same position). Because of this simple relation, the operation is fully
