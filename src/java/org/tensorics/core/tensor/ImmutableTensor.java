 ...
 * <p>
 * By constraint of creation it holds a set of {@link Position} of type C and
 * values of type T, such that ALL Positions contains the same number and type
 * of coordinates. Number and type of coordinates can be accessed and explored
 * via {@link Shape}.
 * <p>
...
public class ImmutableTensor<T> implements Tensor<T> {
	 ...
	 * 
	 * @param dimensions a set of classes that can later be used as coordinates
	 ...
	 * 
	 * @param dimensions the desired dimensions of the tensor. This has to be
