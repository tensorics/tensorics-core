...
public final class Covariants {
	...
	/**
	 * Retrieves an instantiator, which can create instances of the given
	 * covariant class from the bare coordinate instances. The type of the
	 * coordinate class (constructor argument for the covariant class) is taken
	 * from the generic argument of the passed in class. The returned
	 * instantiator is re usable and thread safe.
	 * 
	 * @param covariantClass
	 *            the type of objects that shall be instantated
