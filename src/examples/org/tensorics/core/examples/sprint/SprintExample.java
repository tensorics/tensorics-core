...
public class SprintExample extends TensoricDoubleSupport {
    ...
    public void setUp() {
        ...
        team1Velocity = from(velocity).extractSliceAt(TEAM_1);
        team3Velocity = from(velocity).extractSliceAt(TEAM_3);
    ...
    public void testContext() {
        ...
        Tensor<Double> sliceAtOneDay = from(team1Velocity).extractSliceAt(new NumberOfDay(1));
