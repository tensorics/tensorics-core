...
import static org.tensorics.core.lang.TensoricDoubles.confidenceLevelOf;
...
public class QuantifiedPredicatesTest {
    ...
    public void compareAtDifferentConfidenceLevels() {
        ...
        assertFalse(TensoricDoubles.testIf(v1).isLessThan(v3));

        final TensoricSupport<Double> withLowConfidence = TensoricDoubles.with(confidenceLevelOf(0.68));
    ...
    public void compareEqualValue() {
        ...
        assertFalse(TensoricDoubles.testIf(v1).isLessThan(v1));
        assertFalse(TensoricDoubles.testIf(v1).isGreaterThan(v1));
    }
    ...
    public void throwOnInconsistentUnits() {
        ...
        TensoricDoubles.testIf(v1).isLessThan(v2);
        TensoricDoubles.testIf(v1).isGreaterThan(v2);
    }
    ...
    public void convertUnitsForComparison() {
        ...
        assertFalse(TensoricDoubles.testIf(v1).isLessThan(v2));
        assertTrue(TensoricDoubles.testIf(v1).isGreaterThan(v2));
    }
