...
/**
 * Extension of {@link AbstractDiscreteFunctionVs1DTensorTest} that focuses on testing 1D tensors which have coordinates
 * in common.
 * 
 * @author caguiler
 */
...
public class DiscreteFunctionVs1DTensorWithCommonCoordinatesTest extends AbstractDiscreteFunctionVs1DTensorTest {
    ...
    public void setUp() {
        ...
        for (double i = 0; i < 10; ++i) {
            ...
            builder3.put(Position.of(coordinates1), 3.0);
        }
