...
/**
 * The aim of this test is to compare the difference of features we have between
 * {@link Tensor}s and {@link DiscreteFunction}s.
 * <p>
 * This test focuses on testing binary operations (addition, substraction,
 * multiplication). It also tests reduction operations like AVG, RMS and STD.
 * 
 * @author caguiler
 */
