...
public class TestUtil {
	...
	/**
	 * Verifies that a utility class is well defined according to our
	 * conventions. Thus, the following conditions are verified:
	 * <p>
	 * <ul>
	 ...
	 * </ul>
	 * Additionally, the private constructor is called once, to eliminate noise
	 * in coverage reports.
	 * <p>
	 * Taken from <a href=
	 * "https://github.com/trajano/maven-jee6/tree/master/maven-jee6-test">here</a>
	 * 
	 * @param clazz
	 *            the utility class to verify.
	 * @return {@code true} if everything is fine. Actually, it will never
	 *         return anything else. This return value is mainly there to put an
	 *         'innocent' assert to the unit test where this method is used, to
	 *         satisfy sonar.
	 */
